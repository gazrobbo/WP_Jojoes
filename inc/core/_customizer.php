 ...
 */
function fump_customize_register( $wp_customize )
{
    ...
    $wp_customize->selective_refresh->add_partial( 'blogname', array(
        ...
        'render_callback' => 'fump_customize_partial_blogname',
    ) );

    $wp_customize->selective_refresh->add_partial( 'blogdescription', array(
        'selector' => '.site-description',
        'render_callback' => 'fump_customize_partial_blogdescription',
    ) );
    ...
    $wp_customize->add_section( 'theme_options', array(
        'title' => __( 'Theme Options', 'fump' ),
        'priority' => 130, // Before Additional CSS.
    ) );

    $wp_customize->add_section( 'post_types', array(
        'title' => __( 'Post Type Archives', 'fump' ),
        'priority' => 130, // Before Additional CSS.
    ) );
    ...
    $wp_customize->add_control( 'site_top_use_customizer',
        array(
            ...
            'type' => 'radio',
            'description' => __('You can make your own layout in header.php and ignore all this.', 'fump'),
            'choices' => array(
                'yes' => 'yes',
                'no' => 'no'
            )
    ...
    $wp_customize->add_control( 'site_top_contained',
        array(
            'label' => __( 'Contain the site top items', 'fump' ),
            'section' => 'theme_options',
            'type' => 'select',
            'choices' => array(
                'container' => 'contained',
            ...
            'description' => __('You can set contained size via $container in scss', 'fump')
        ) );
    ...
    $wp_customize->add_control( 'site_top_layout',
        array(
            ...
            'section' => 'theme_options',
            'type' => 'select',
            'description' => __('You can make your own layout in php in header.php and ignore presets and manual settings.', 'fump'),
            'choices' => array(
                'logo-left' => 'logo-left',
...
add_action( 'customize_register', 'fump_customize_register' );
 ...
 *
 * @since Ignition 1.0
 * @see fump_customize_register()
 *
 * @return void
 */
function fump_customize_partial_blogname()
{
    bloginfo( 'name' );
}
 ...
 * @return void
 */
function fump_customize_partial_blogdescription()
{
 ...
 */
function fump_customize_preview_js()
{
    wp_enqueue_script( 'fump-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js'
    ), array('jquery', 'customize-preview'), '1.0', true );
}

add_action( 'customize_preview_init', 'fump_customize_preview_js' );

/**
 * Load dynamic logic for the customizer controls area.
 */
function fump_panels_js()
{
    wp_enqueue_script( 'fump-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
//add_action( 'customize_controls_enqueue_scripts', 'fump_panels_js' );
