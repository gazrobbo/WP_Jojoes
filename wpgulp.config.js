...
module.exports = {
	...
	// Project options.
	projectURL: 'http://jojoes-dog-grooming.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'fump', // Your textdomain here.
	translationFile: 'fump', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'fump', // Package name.
