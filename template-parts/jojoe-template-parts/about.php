	...
	<div class="container about-container" >
		...
		<div class="section1">
			...
			<p>We are one of the top dog groomers in Hull,
				...
				a family-run team who all share a passion for dogs. Catering for all breeds at competitive prices and provide a
				safe
		...
		<div class="section2">
			<h3>Dog lovers</h3>
			<P>Our team are all dog owners and truly love animals that is why we have chosen this career. Your pet's wellbeing
				is
				our priority. We only accept a limited number of dogs per day this allows us to spend time with your dog. We try
				and
