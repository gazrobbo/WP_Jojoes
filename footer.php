...
<div id="outdated">
    <h6><?php _e( 'Your browser is out-of-date!', 'fump' ); ?></h6>
    <p><?php _e( 'Update your browser to view this website correctly.', 'fump' ); ?> <a id="btnUpdateBrowser"
                                                                                            href="http://outdatedbrowser.com/"><?php _e( 'Update
			my browser now', 'fump' ); ?></a></p>
